...
# parser.add_argument("--rec", default="true_rec", choices=['false_rec', 'true_rec'])
parser.add_argument("--rec", default="false_rec", choices=['false_rec', 'true_rec']) #20220613 modify

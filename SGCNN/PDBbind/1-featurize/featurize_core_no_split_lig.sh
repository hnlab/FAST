#!/bin/bash
#$ -S /bin/bash
#$ -N core_lig_2016_featurize
#$ -q cuda
#$ -o /pubhome/xli02/project/PLIM/deep_learning/FAST/fast_plim/PDBbind/pdbbind_v2016/1-featurize/log/pdbbindv2016_core_ligand_alone_pybel.log
#$ -j y
#$ -r y
#$ -l gpu=1
#$ -notify
...
python 1-featurize/featurize_core_no_split.py \
    ...
    --output datasets/core/lig_alone \
